 ...
 * 
 * Autores:
 * - Dante Alejandro alegrÃƒÂ­a Romero      
 * - Diego Alberto Aranda                        
 * - Andrea Margarita Balandran Felix  
 * - MarÃƒÂ­a Yoselin GarcÃƒÂ­a Medina                
 * - Moreno SÃƒÂ¡nchez Diego Emilio @YeyoM        
 * 
 * Fecha: 26/09/2022
 * 
 * DescripciÃƒÂ³n:
...
/**
 * FunciÃƒÂ³n para contar el nÃƒÂºmero de veces que aparece un caracter en una cadena
 * @param c Caracter a contar
 * @param str Cadena a buscar
 * @return El nÃƒÂºmero de veces que aparece el caracter c en la cadena str
*/
...
/**
 * FunciÃƒÂ³n para generar un nÃƒÂºmero aleatorio entre un rango
 * @param minimo El nÃƒÂºmero mÃƒÂ­nimo que se desea generar
 * @param maximo El nÃƒÂºmero mÃƒÂ¡ximo que se desea generar
*/
...
/**
 * FunciÃƒÂ³n para generar una cadena aleatoria
 * @param longitud La longitud de la cadena a generar
 * @param destino La cadena donde se almacenarÃƒÂ¡ la cadena aleatoria
*/
...
/**
 * FunciÃƒÂ³n para obtener el nÃƒÂºmero mayor de ceros en un arreglo
 * @param arr El arreglo de nÃƒÂºmeros
 * @param n El nÃƒÂºmero de elementos en el arreglo
 * @return El nÃƒÂºmero mayor de ceros en el arreglo
*/
...
int main() {
  ...
  /* Definiendo el nÃƒÂºmero de individuos a generar. */
  #define NUMERO_DE_CADENAS 250

  /* Inicializando el generador de nÃƒÂºmeros aleatorios con el ID del proceso del programa. */
  srand(getpid());
  ...
  /* Definiendo el arreglo de nÃƒÂºmeros para guardar el nÃƒÂºmero de ceros en cada cadena. */
