...
/**
 * FunciÃ³n para contar el nÃºmero de veces que aparece un caracter en una cadena
 * @param c Caracter a contar
 * @param str Cadena a buscar
 * @return El nÃºmero de veces que aparece el caracter c en la cadena str
*/
...
/**
 * FunciÃ³n para generar un nÃºmero aleatorio entre un rango
 * @param minimo El nÃºmero mÃ­nimo que se desea generar
 * @param maximo El nÃºmero mÃ¡ximo que se desea generar
*/
 ...
 * @param destino La cadena donde se almacenarÃ¡ la cadena aleatoria
*/
...
/**
 * FunciÃ³n para obtener el nÃºmero mayor de ceros en un arreglo
 * @param arr El arreglo de nÃºmeros
 * @param n El nÃºmero de elementos en el arreglo
 * @return El nÃºmero mayor de ceros en el arreglo
*/
...
int main() {
  ...
  /* Definiendo el nÃºmero de individuos a generar. */
  #define NUMERO_DE_CADENAS 250

  /* Inicializando el generador de nÃºmeros aleatorios con el ID del proceso del programa. */
  srand(getpid());
  ...
  /* Definiendo el arreglo de nÃºmeros para guardar el nÃºmero de ceros en cada cadena. */
  ...
  for (int k = 0; k < NUMERO_DE_CADENAS / 2; k++) {
    ...
    if (k == 0) {
       ...
       * a) Tomando como restricciÃ³n los Ãºltimos 5 individuos, 
       *    elegir 2 individuos al azar, que serÃ­a equivalente al 20% de la poblaciÃ³n.
       * b) Generar para cada individuo seleccionado (de los dos), 
       *    un porcentaje del 10 al 40%, para elegir con su porcentaje el 
       *    cambio(mutaciÃ³n) del bit( 0 cambia a 1, Ã³ 1 cambia a 0); si se generÃ³
       ...
       * d) Volver a ordenar y repetir la acciÃ³n para cada generaciÃ³n
      */
      ...
      if (individuosCeros < 8) {
        ...
        while(seleccionados < 2) {
          if (individuosCeros >= 5) {
            ...
            indiceParaMutacion = aleatorioEnRango(1, 9);
          }
